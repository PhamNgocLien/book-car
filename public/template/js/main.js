...
(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        $("#slideslow-bg").vegas({
            ...
            slides: [
                {
                    src: 'template/img/slider-img/slider-img-1.jpg'
                },
                {
                    src: 'template/img/slider-img/slider-img-2.jpg'
                },
                {
                    src: 'template/img/slider-img/slider-img-3.jpg'
                },
                {
                    src: 'template/img/slider-img/slider-img-4.jpg'
                }
            ]
        }); //Home Page Two Slideshow
